        ...
        <div class="form-group">
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <asp:TextBox ID="txtSummary" runat="server" TabIndex="5" placeholder="Price" CssClass="form-control" TextMode="Number" min="0" max="10000000" required="required"></asp:TextBox>
            </div>
        </div>
