<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="UpdateBonus.aspx.cs" Inherits="GUI.UpdateBonus" %>
        ...
        <table class="styled-table">
            <tr>
                ...
                <td class="auto-style7">
                    <asp:TextBox ID="txtbonusid" runat="server" Width="304px" required ="required" Enabled ="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td style="height:300px; width:330">
            ...
            <tr>
                <td colspan="2">
                    <asp:Button ID="update" runat="server" Text="Update" CssClass="myButton" OnClick="updatebonus" />
                </td>
            </tr>
        </table>
    </div>
