        ...
        <table class="styled-table">
            <tr>
                ...
                <td class="auto-style7">
                    ...
                    <asp:CustomValidator runat="server" id="cusCustom" controltovalidate="txtbonusid" onservervalidate="validateBonusID" errormessage="Bonus ID đã tồn tại" class="fa fa-warning" style="color:red"/>
                </td>
            </tr>
            <tr>
                <td>
